module.exports = class Data1667505921619 {
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "extrinsic" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "extrinsic_hash" text, "index_in_block" integer NOT NULL, "version" integer NOT NULL, "signer" text, "success" boolean NOT NULL, "error" text, "tip" numeric, "fee" numeric, "block_id" character varying, "call_id" character varying, "event_id" character varying, CONSTRAINT "PK_80d7db0e4b1e83e30336bc76755" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE INDEX "IDX_e88607255accbed4945ceb7934" ON "extrinsic" ("event_id") `)
    ...
    await db.query(`ALTER TABLE "extrinsic" ADD CONSTRAINT "FK_e88607255accbed4945ceb7934b" FOREIGN KEY ("event_id") REFERENCES "event"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_e88607255accbed4945ceb7934"`)
    ...
    await db.query(`ALTER TABLE "extrinsic" DROP CONSTRAINT "FK_e88607255accbed4945ceb7934b"`)
