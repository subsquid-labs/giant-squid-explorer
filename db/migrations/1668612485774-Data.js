module.exports = class Data1668612485774 {
  name = 'Data1668612485774'
  ...
  async up(db) {
    ...
    await db.query(`CREATE INDEX "IDX_8b212022b7428232091e2f8aa5" ON "call" USING HASH ("name") `)
    ...
    await db.query(`CREATE INDEX "IDX_b535fbe8ec6d832dde22065ebd" ON "event" USING HASH ("name") `)
    ...
    await db.query(`CREATE INDEX "IDX_001ddf290faf765f9dfd9154d3" ON "extrinsic" USING HASH ("signer") `)
