module.exports = class Data1669063648413 {
  name = 'Data1669063648413'

  async up(db) {
    await db.query(`CREATE TABLE "call" ("id" character varying NOT NULL, "parent_id" text, "extrinsic_hash" text, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "event_name" text NOT NULL, "pallet_name" text NOT NULL, "success" boolean NOT NULL, "caller" text, "args_str" text, "block_id" character varying, "extrinsic_id" character varying, CONSTRAINT "PK_2098af0169792a34f9cfdd39c47" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE INDEX "IDX_96b9662898f52cdb5e16a3a102" ON "call" ("caller") `)
    await db.query(`CREATE INDEX "IDX_5240f930edb0584f7beae2f459" ON "call" ("event_name", "pallet_name") `)
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_96b9662898f52cdb5e16a3a102"`)
    await db.query(`DROP INDEX "public"."IDX_5240f930edb0584f7beae2f459"`)
